document.addEventListener("DOMContentLoaded", function() {
  ...
  submitButton.addEventListener("click", function() {
    ...
    if(checkin<=checkout){
      ...
      const confirmationPageURL = `reservation_confirmation.html?checkin=${checkin}&checkout=${checkout}&adults=${adults}&children=${children}&rooms=${rooms}&totalBill=${totalBill}`;
